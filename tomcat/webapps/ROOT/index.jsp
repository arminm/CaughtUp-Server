    ...
    <body>
        <div id="wrapper">
            <div id="navigation" class="curved container">
                ...
                <span id="nav-lists"><a href="${tomcat7Url}lists.html">Email Lists</a></span>
            ...
            <div id="upper" class="curved container">
                <div id="congrats" class="curved container">
                    <h2>If you're seeing this, you've successfully installed Tomcat 7. Congratulations!<br/>
		            <b><font color="red" size="-2">Pre-configured version from Marty Hall
	                and coreservlets.com. See <a href="http://www.coreservlets.com/Apache-Tomcat-Tutorial/">
            ...
            <div id="middle" class="curved container">
                ...
                <div class="col25">
                    <div class="container">
                        <p><a href="http://www.coreservlets.com/JSF-Tutorial/jsf2/">JSF 2 Tutorial</a></p>
                        <p><a href="http://docs.coreservlets.com/servlet-3.0-api/">Servlet 3.0 &amp; JSP 2.2 API</a></p>
                        <p><a href="http://www.coreservlets.com/JSF-Tutorial/primefaces/">PrimeFaces Tutorial</a></p>
                    </div>
                </div>
                <div class="col25">
                    <div class="container">
                        ...
                        <p><a href="http://courses.coreservlets.com/jsf-training.html">JSF 2 &amp; PrimeFaces Training</a></p>
                    </div>
                </div>
                <br class="separator" />
            </div>
